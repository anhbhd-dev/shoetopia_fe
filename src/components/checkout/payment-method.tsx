...
import { PaymentMethodDataType } from "@/types/payment-method.type";
...
export default function PaymentMethodSelection() {
  ...
  const VNPayData = paymentMethodData.find(
    (item: PaymentMethodDataType) => item.name === PaymentMethod.VNPAY
  );
